...
public class AddingVectors {
    ...
    public static void saveVectorToFile(ArrayList<Integer> vector) {
        ...
        System.out.println("Saved that bad boi vector to file!");
    }

    public static ArrayList<Integer> addVectors(ArrayList<Integer> v1, ArrayList<Integer> v2)
            throws DifferentLengthVectors {
        if (v1.size() != v2.size())
